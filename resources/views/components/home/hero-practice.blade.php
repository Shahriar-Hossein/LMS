<div class="flex relative justify-center items-center  min-h-screen overflow-hidden">
    <div class="w-full lg:w-1/2 h-screen flex items-center justify-center bg-[url('/public/images/study.png')] bg-cover bg-center lg:bg-gradient-to-l from-cyan-200 to-emerald-300 p-8">

        <div class="flex flex-col max-w-md bg-transparent text-gray-950">
            ...
            <a href="#"
            class="h-12 w-34 text-nowrap hover:-translate-y-1 inline-block bg-gradient-to-l from-cyan-600 to-emerald-600 text-gray-100 font-semibold px-6 py-3 mb-4 rounded-md shadow hover:from-emerald-600 transition duration-400 ease-in drop-shadow-lg">
            Get Started
            </a>
    ...
    <div class="hidden lg:flex justify-end items-center relative w-3/4">
        <div class="hidden lg:block rotate-90 absolute min-w-screen">
